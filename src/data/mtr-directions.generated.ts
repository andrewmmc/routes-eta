...
export const MTR_LINE_DIRECTIONS = [
  ...
  },
  {
    ...
    stations: [
      ...
      { code: "RAC", id: "70", nameZh: "馬場", nameEn: "Racecourse", sequence: 9 },
      { code: "UNI", id: "71", nameZh: "大學", nameEn: "University", sequence: 10 },
      { code: "TAP", id: "72", nameZh: "大埔墟", nameEn: "Tai Po Market", sequence: 11 },
      { code: "TWO", id: "73", nameZh: "太和", nameEn: "Tai Wo", sequence: 12 },
      { code: "FAN", id: "74", nameZh: "粉嶺", nameEn: "Fanling", sequence: 13 },
      { code: "SHS", id: "75", nameZh: "上水", nameEn: "Sheung Shui", sequence: 14 },
      { code: "LMC", id: "78", nameZh: "落馬洲", nameEn: "Lok Ma Chau", sequence: 15 },
      { code: "LOW", id: "76", nameZh: "羅湖", nameEn: "Lo Wu", sequence: 16 },
    ],
    startTermini: ["ADM"],
    endTermini: ["LMC", "LOW"],
  },
  {
    ...
    stations: [
      ...
      { code: "LOW", id: "76", nameZh: "羅湖", nameEn: "Lo Wu", sequence: 2 },
      { code: "SHS", id: "75", nameZh: "上水", nameEn: "Sheung Shui", sequence: 3 },
      { code: "FAN", id: "74", nameZh: "粉嶺", nameEn: "Fanling", sequence: 4 },
      { code: "TWO", id: "73", nameZh: "太和", nameEn: "Tai Wo", sequence: 5 },
      { code: "TAP", id: "72", nameZh: "大埔墟", nameEn: "Tai Po Market", sequence: 6 },
      { code: "UNI", id: "71", nameZh: "大學", nameEn: "University", sequence: 7 },
      { code: "RAC", id: "70", nameZh: "馬場", nameEn: "Racecourse", sequence: 8 },
      { code: "FOT", id: "69", nameZh: "火炭", nameEn: "Fo Tan", sequence: 9 },
      { code: "SHT", id: "68", nameZh: "沙田", nameEn: "Sha Tin", sequence: 10 },
      { code: "TAW", id: "67", nameZh: "大圍", nameEn: "Tai Wai", sequence: 11 },
      { code: "KOT", id: "8", nameZh: "九龍塘", nameEn: "Kowloon Tong", sequence: 12 },
      { code: "MKK", id: "65", nameZh: "旺角東", nameEn: "Mong Kok East", sequence: 13 },
      { code: "HUH", id: "64", nameZh: "紅磡", nameEn: "Hung Hom", sequence: 14 },
      { code: "EXC", id: "94", nameZh: "會展", nameEn: "Exhibition Centre", sequence: 15 },
      { code: "ADM", id: "2", nameZh: "金鐘", nameEn: "Admiralty", sequence: 16 },
    ],
    startTermini: ["LMC", "LOW"],
    endTermini: ["ADM"],
  },
  {
    lineCode: "ISL",
  ...
  },
  {
    ...
    stations: [
      ...
      { code: "LHP", id: "57", nameZh: "康城", nameEn: "LOHAS Park", sequence: 7 },
      { code: "POA", id: "52", nameZh: "寶琳", nameEn: "Po Lam", sequence: 8 },
    ],
    startTermini: ["NOP"],
    endTermini: ["LHP", "POA"],
  },
  {
    ...
    stations: [
      ...
      { code: "POA", id: "52", nameZh: "寶琳", nameEn: "Po Lam", sequence: 2 },
      { code: "HAH", id: "51", nameZh: "坑口", nameEn: "Hang Hau", sequence: 3 },
      { code: "TKO", id: "50", nameZh: "將軍澳", nameEn: "Tseung Kwan O", sequence: 4 },
      { code: "TIK", id: "49", nameZh: "調景嶺", nameEn: "Tiu Keng Leng", sequence: 5 },
      { code: "YAT", id: "48", nameZh: "油塘", nameEn: "Yau Tong", sequence: 6 },
      { code: "QUB", id: "32", nameZh: "鰂魚涌", nameEn: "Quarry Bay", sequence: 7 },
      { code: "NOP", id: "31", nameZh: "北角", nameEn: "North Point", sequence: 8 },
    ],
    startTermini: ["LHP", "POA"],
    endTermini: ["NOP"],
  },
  {
    lineCode: "TML",
